...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.grp_Type.setFocusPolicy(Qt.StrongFocus)
        ...
        self.txt_Dest.setTabChangesFocus(True)
        self.txt_Dest.setAcceptRichText(False)
        ...
        self.frm_Sniff.setFocusPolicy(Qt.StrongFocus)
    ...
    def set_tab_order(self, Dialog):
        Dialog.setTabOrder(self.frm_Sniff, self.chk_Sniff)
        Dialog.setTabOrder(self.chk_Sniff, self.txt_time)
        # Dialog.setTabOrder(self.txt_time, self.chk_Ping)
        Dialog.setTabOrder(self.txt_time, self.frm_Ping)
        Dialog.setTabOrder(self.frm_Ping, self.chk_Ping)

        Dialog.setTabOrder(self.chk_Ping, self.txt_From)

        Dialog.setTabOrder(self.txt_From, self.txt_Dest)
        Dialog.setTabOrder(self.txt_Dest, self.lst_Result)
        Dialog.setTabOrder(self.lst_Result, self.btn_OK)
        Dialog.setTabOrder(self.btn_OK, self.btn_Export)
        Dialog.setTabOrder(self.btn_Export, self.btn_Cancel)
        Dialog.setTabOrder(self.btn_Cancel, self.frm_Sniff)
